...
export const id_is_statement = (id: string | undefined) => !!id && statement_id_regex.test(id)

const pattern_id_regex = new RegExp(/^p\d/)
export const id_is_pattern = (id: string | undefined) => !!id && pattern_id_regex.test(id)

const object_id_regex = new RegExp(/^o\d/)
export const id_is_object = (id: string | undefined) => !!id && object_id_regex.test(id)
